...
class Tests {
    ...
    fun dateStrToDigit() {
        ...
        assertEquals("30.04.1", dateStrToDigit("30 апреля 1"))
    }
    ...
    fun dateDigitToStr() {
        ...
        assertEquals("2 января 7049447", dateDigitToStr("02.01.7049447"))
        assertEquals("2 января 2", dateDigitToStr("02.01.2"))
    }
